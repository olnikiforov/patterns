...
public class Client {
    public static void main(String[] args) {
        ...
        AuthenticationHandler authenticationChain = new GuestAuthenticationHandler();
        authenticationChain.setNext(new UserAuthenticationHandler(usersAccounts))
                .setNext(new AdminAuthenticationHandler(adminsAccounts));
        ...
        for (Account user : users) {
            authenticationChain.authenticate(user);
        }
    }
}
